            ...
            <table class="table bordered-table table-heading-dark-mode mb-0">
               ...
               <tbody>
                  <tr ng-repeat="question in questions track by question.id">
                     <td>@{{$index + 1}}</td>
                     <td class="text-primary-light">@{{question.question}}</td>
                     <td class="text-primary-light">@{{question.right_answer}}</td>
                     <td>
                  ...
                  <tr ng-if="!questions.length">
                     <td colspan="5" class="text-center py-4 text-secondary-light">No questions found.</td>
                  </tr>
               </tbody>
            </table>
         </div>
                        ...
                        <div class="border border-neutral-200 radius-8 p-16 bg-base">
                           ...
                           <div class="row g-3">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <input type="number" class="form-control" ng-model="questionForm.total_marks" readonly>
                              </div>
                              <div class="col-md-4">
