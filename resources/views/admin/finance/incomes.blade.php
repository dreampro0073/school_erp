...
<div ng-controller="incomesCtrl" ng-init="init();" class="mt-24">
   <div class="card mb-16">
      <div class="card-body">
         <form class="row g-3" ng-submit="save()">
            <div class="col-md-6">
            ...
            <div class="col-md-3">
               ...
               <select class="form-control" ng-model="formData.active"><option value="1">Active</option><option value="0">Inactive</option></select>
            </div>
            <div class="col-md-3 d-flex align-items-end">
               <button class="btn btn-primary w-100" type="submit">@{{formData.id ? 'Update' : 'Add'}} Income</button>
            </div>
         </form>
      </div>
   </div>
