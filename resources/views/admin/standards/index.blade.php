...
@section('main')
<div ng-controller="standardsCtrl" ng-init="init();">
   <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
         <h6 class="fw-semibold mb-0">Standards</h6>
         <p class="text-neutral-600 mt-4 mb-0">Manage standards list.</p>
      </div>
      ...
      <div class="card-body p-0">
         <div class="table-responsive">
            <table class="table bordered-table mb-0">
               ...
               <tbody>
                  <tr ng-repeat="item in standards track by item.id">
                     <td>@{{$index + 1}}</td>
                     <td>@{{item.name}}</td>
                     <td>
                     ...
                     <td>
                        ...
                        <button type="button" class="btn btn-sm btn-danger-100 text-danger-600" ng-click="deleteStandard(item)">Delete</button>
                     </td>
                  </tr>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title">@{{ formData.id ? 'Edit Standard' : 'Add Standard' }}</h5>
