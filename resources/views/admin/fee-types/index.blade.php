...
@section('main')
<div ng-controller="feeTypesCtrl" ng-init="init();">
   <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
         <h6 class="fw-semibold mb-0">Fee Types</h6>
         <p class="text-neutral-600 mt-4 mb-0">Manage fee types list.</p>
      </div>
      ...
      <div class="card-body p-0">
         <div class="table-responsive">
            <table class="table bordered-table mb-0">
               ...
               <tbody>
                  <tr ng-repeat="item in feeTypes track by item.id">
                     <td>@{{$index + 1}}</td>
                     <td>@{{item.name}}</td>
                     <td>
                     ...
                     <td>
                        ...
                        <button type="button" class="btn btn-sm btn-danger-100 text-danger-600" ng-click="deleteFeeType(item)">Delete</button>
                     </td>
                  </tr>
                  <tr ng-if="!feeTypes.length">
                     <td colspan="4" class="text-center py-4">No fee types found.</td>
                  </tr>
               </tbody>
            </table>
         </div>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title">@{{ formData.id ? 'Edit Fee Type' : 'Add Fee Type' }}</h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form ng-submit="saveFeeType()">
