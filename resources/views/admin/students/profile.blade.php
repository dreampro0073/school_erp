...
@section('main')
<div class="ng-cloak" ng-controller="studentDetailsCtrl" ng-init="student_token={{$student_token}};getDetails();">
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div class="">
            <h1 class="fw-semibold mb-4 h6 text-primary-light">Student Details</h1>
           <!--  <div class="">
                <a href="{{url('admin/da')}}" class="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
            ...
            <div class="my-16">
                <div class="d-flex align-items-center gap-2">
                    <ul class="p-12 nav nav-pills bordered-tab" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a href="javascript:;" ng-click="getDetails();changeTab(1)" class="nav-link d-flex align-items-center gap-8 text-secondary-light fw-medium text-sm text-hover-primary-600 text-capitalize bg-transparent px-20 py-12 " ng-class="{'active': tab == 1 }">
                        ...
                        <li class="nav-item">
                            <a href="javascript:;" ng-click="getLeaves();changeTab(3)" class="nav-link d-flex align-items-center gap-8 text-secondary-light fw-medium text-sm text-hover-primary-600 text-capitalize bg-transparent px-20 py-12 " ng-class="{'active': tab == 3 }"> 
                                <span class="d-flex tab-icon line-height-1 text-md">
