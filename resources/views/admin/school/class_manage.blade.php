...
<div ng-controller="classManagementCtrl" ng-init="class_id= {{$class_id}}; initClass();">
   <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3">
      <div>
         <h6 class="fw-semibold mb-0">Class : @{{ standard.name}}</h6>
      </div>
   ...
   <div class="tab-content" id="pills-tabContent">
      ...
      <div ng-show="!loading">
         <div class="tab-pane fade" role="tabpanel" ng-show="type == 'fee'" ng-class="{'active show tab-pane-animate': type == 'fee'}">

          @include('admin.school.fee')
         </div>
