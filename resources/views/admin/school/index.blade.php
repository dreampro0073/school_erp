...
<div ng-controller="schoolManagementCtrl" ng-init="init();">
   <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3">
      ...
      <div class="d-flex align-items-center gap-2">
         <ul class="p-12 nav nav-pills bordered-tab" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
               <a href="javascript:;" ng-click="type = 'classes'; typeClasses()" class="nav-link d-flex align-items-center gap-8 text-secondary-light fw-medium text-sm text-hover-primary-600 text-capitalize bg-transparent px-20 py-12 " ng-class="{'active': type == 'classes'}"> <i class="ri-artboard-2-line"></i>Classes</a>
               
            </li>
            <li class="nav-item">
               <a href="javascript:;" ng-click="type = 'transport'; typeTransport()" class="nav-link d-flex align-items-center gap-8 text-secondary-light fw-medium text-sm text-hover-primary-600 text-capitalize bg-transparent px-20 py-12 " ng-class="{'active': type == 'transport'}"> <i class="ri-bus-line"></i>Transport</a>
   ...
   <div class="tab-content" id="pills-tabContent">
      ...
      <div ng-show="!loading">
         ...
         <div class="tab-pane fade" role="tabpanel"
           ng-show="type == 'transport'"
           ng-class="{'active show tab-pane-animate': type == 'transport'}">
            @include('admin.school.transport_routes')
         </div>
